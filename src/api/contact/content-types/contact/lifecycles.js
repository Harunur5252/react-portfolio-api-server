    ...
    try {
      await strapi.plugins["email"].services.email.send({
        ...
        html: `
               ...
               <h4>If you are not registered , please register and see all blogs,manage dashboard etc. Here is the link : </h4> 
               <h4>Here is register link : <a href='http://localhost:5173/register'>Click Here</a></h4> 
              `,
      });
    } catch (err) {
      console.log(err);
